...
namespace JsonToExcel.Controllers
{
    ...
    public class ExcelUtilityController : ControllerBase
    {
        ...
        public Task<IActionResult> DownloadExcel(ExcelUtilModel excelUtil)
        {
            ...
            // You can Import JSON Data form json file too.
            ...
            return Task.FromResult<IActionResult>(File(buffer, "application/octet-stream", $"{excelUtil.FileName}.xls")); // returns a FileStreamResult
        }
